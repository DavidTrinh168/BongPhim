...
import { createrMovie, getMovies, getMovieDetail, deleteMovie /*, updatMovie*/ } from '../controllers/movie.controller.js';
...
// internalMovieRouter.patch('/:id', verifyToken, authorizeRole(['admin', 'moderator']), updatMovie);
